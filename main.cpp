...
int main()
{
    pizzaMenu pizza[20]; // struct array of pizza
	
    int selectedOption = 0; // user selected input
    
    int no_of_pizza = 0; // number of pizza in the file
    ...
    while(selectedOption != 4) {
        ...
        display_options(); // function call to display options
        selectedOption = read_user_choice(); // set the user input to variable
    }
    
    show_quit_message(); // when user selects 4, show message
